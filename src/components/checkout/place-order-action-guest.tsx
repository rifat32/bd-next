...
import { useCreateOrder, useCreateOrderGuest, useOrderStatuses } from '@/framework/order';
...
export const PlaceOrderActionGuest: React.FC<{ className?: string }> = (props) => {
  const { t } = useTranslation('common');
  const [errorMessage, setErrorMessage] = useState<string | null>(null);
  const { createOrder, isLoading } = useCreateOrderGuest();
