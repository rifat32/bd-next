...
import { PlaceOrderActionGuest } from '../place-order-action-guest';

interface Props {
  className?: string;
}
const VerifiedItemListGuest: React.FC<Props> = ({ className }) => {
  ...
  return (
    <div className={className}>
      ...
      <PlaceOrderActionGuest>{t('text-place-order')}</PlaceOrderActionGuest>
    </div>
  );
};

export default VerifiedItemListGuest;
